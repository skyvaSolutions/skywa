...
Future<void> showDialogForDate(
    contextParent, name, index, goToCurrentScreen) async {
  ...
  Future<Null> _selectTime(BuildContext context) async {
    ...
    var hour = picked.hour.toString().length == 1
  ...
  return showDialog<void>(
    ...
    builder: (BuildContext context) {
      return StatefulBuilder(builder: (context, myState) {
        final p = Provider.of<createReservationProvider>(context);
        return AlertDialog(
          title: Text('Welcome'),
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                print(date);
                p.createReservation(
                    contextParent, date, name, index, goToCurrentScreen);
